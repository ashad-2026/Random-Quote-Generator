...
class RandomQuoteGenerator:
    def __init__(self, root):
        ...
        self.quotes = [
            ...
            {"text": "Счастье — это когда тебя понимают", "author": "Антон Чехов", "topic": "Счастье"},
            {"text": "В жизни всегда есть место подвигу", "author": "Максим Горький", "topic": "Мотивация"},
    ...
    def create_widgets(self):
        ...
        self.quote_text = tk.Label(self.root, text="", wraplength=400, justify="center", font=("Arial", 12))
        ...
        # История цитат
        tk.Label(self.root, text="История цитат (последние 20):").pack(pady=5)
        self.history_list = scrolledtext.ScrolledText(self.root, height=10, width=70)
